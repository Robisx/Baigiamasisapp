...
/**
 * Created by User1 on 2017-04-10.
 */

public class VartotojasJson {
    String vartotojopav;
    String slaptazodis;
    String vardas;
    String pavarde;
    ...
    public VartotojasJson(String vartotojopav, String slaptazodis, String vardas, String pavarde, String elPastas, String amzius, String telefonas) {
